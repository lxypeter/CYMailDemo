...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
  ...
  if ([delegate respondsToSelector:@selector(imagePicker:didSelectImage:andALAssetRepresentation:)]) {
      [delegate imagePicker:self didSelectImage:image andALAssetRepresentation:representation];
  }
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info {
  ...
  if ([delegate respondsToSelector:@selector(imagePicker:didSelectImage:andALAssetRepresentation:)]) {
          [delegate imagePicker:self didSelectImage:chosenImage andALAssetRepresentation:imageFileName];
      }
    [self dismissAnimated:YES];
  }];
}
